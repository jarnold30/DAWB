...
namespace JA.Risk
{
	...
	/// </remarks>
	public partial class RiskHelpKeywordHelper : RiskHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new RiskHelpKeywordHelper.
		/// </summary>
		protected RiskHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the RiskHelpKeywordHelper.
		/// </summary>
		public static RiskHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class RiskHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new RiskHelpKeywordHelperBase.
		/// </summary>
		protected RiskHelpKeywordHelperBase()
			: base() { }
