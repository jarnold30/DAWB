...
namespace JA.Risk
{
	...
	/// <summary>
	/// Base implementation for template directive processor that provides Risk files
	/// </summary>
	public class RiskDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string RiskDirectiveProcessorName = "RiskDirectiveProcessor";
		...
		/// </summary>
		private const string providesModelParameter = "RiskModel";
		...
		/// </summary>
		private const string supportedDirectiveName = "Risk";
		...
		/// Constructor
		/// </summary>
		public RiskDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return RiskDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::JA.Risk.RiskModel));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::JA.Risk.RiskModel));
					...
					if (!this.oneTimeCodeGenerated && global::System.IO.File.Exists(this.Host.TemplateFile))
					{
						...
						resolver.Name = "Convert" + "RiskModel" + "RelativePathToTemplateRelativePath";
				...
				if (languageProvider != null)
				{
					...
					if(LoadDiagramData)
					{
						...
						invokeEnableDiagramRules = new global::System.CodeDom.CodeMethodInvokeExpression(
							new global::System.CodeDom.CodeMethodReferenceExpression(new global::System.CodeDom.CodeTypeReferenceExpression("RiskDomainModel"), "EnableDiagramRules"), new global::System.CodeDom.CodePropertyReferenceExpression(new global::System.CodeDom.CodeThisReferenceExpression(), "Store"));
