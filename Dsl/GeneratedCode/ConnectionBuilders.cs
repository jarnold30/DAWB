...
namespace JA.Risk
{
	...
	/// ConnectionBuilder class to provide logic for constructing connections between elements.
	/// </summary>
	public static partial class PortReferencesTargetPortedBuilder
	{
		#region Accept Connection Methods
		/// <summary>
		/// Test whether a given model element is acceptable to this ConnectionBuilder as the source of a connection.
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			else // Check combinations
			{
				if (candidateSource is global::JA.Risk.Port)
				{
					...
					{
						global::JA.Risk.Port sourcePort = (global::JA.Risk.Port)candidateSource;
						global::JA.Risk.Port targetPort = (global::JA.Risk.Port)candidateTarget;
						if(targetPort == null || sourcePort == null || global::JA.Risk.PortReferencesTargetPorted.GetLinks(sourcePort, targetPort).Count > 0) return false;
						return true;
					}
				}
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::JA.Risk.Port)
				{
					if (target is global::JA.Risk.Port)
					{
						...
						DslModeling::ElementLink result = new global::JA.Risk.PortReferencesTargetPorted(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
