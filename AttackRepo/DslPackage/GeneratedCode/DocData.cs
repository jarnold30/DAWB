...
namespace JA.Attack
{
	...
	/// </summary>
	internal partial class AttackDocData : AttackDocDataBase
	{
		/// <summary>
		/// Constructs a new AttackDocData.
		/// </summary>
		public AttackDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a Attack document in memory.
	/// </summary>
	internal abstract partial class AttackDocDataBase : DslShell::ModelingDocData
	{
		...
		/// <summary>
		/// Constructs a new AttackDocDataBase.
		/// </summary>
		protected AttackDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::JA.Attack.AttackDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::JA.Attack.AttackDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		{
			return new DslShell::VsValidationController(this.ServiceProvider, typeof(AttackExplorerToolWindow));
		}
		/// <summary>
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::JA.Attack.AttackDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::JA.Attack.AttackDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::JA.Attack.AttackGraph modelRoot = null;
			...
			global::JA.Attack.AttackDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::JA.Attack.AttackSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::JA.Attack.AttackDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::JA.Attack.AttackDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected virtual void OnDocumentLoaded()
		{
			...
			global::JA.Attack.AttackGraph modelRoot = this.RootElement as global::JA.Attack.AttackGraph;
			if (modelRoot != null)
			{
				...
				if (diagrams.Count > 0)
				{
					global::JA.Attack.AttackDiagram diagram = diagrams[0] as global::JA.Attack.AttackDiagram;
					if (diagram != null)
					{
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::JA.Attack.AttackGraph modelRoot = (global::JA.Attack.AttackGraph)this.RootElement;
			...
			if (diagrams.Count > 0 && (!saveAs || this.diagramDocumentLockHolder == null))
			{
				...
				if (diagram != null)
				{
					...
					try
					{
						...
						global::JA.Attack.AttackSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::JA.Attack.AttackSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::JA.Attack.AttackDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::JA.Attack.AttackSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				...
				if (modelRoot != null)
				{
					modelFile = global::JA.Attack.AttackSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
