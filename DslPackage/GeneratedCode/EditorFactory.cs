...
namespace JA.Risk
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.RiskEditorFactoryId)]
	internal partial class RiskEditorFactory : RiskEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new RiskEditorFactory.
		/// </summary>
		public RiskEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class RiskEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected RiskEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new RiskDocData(this.ServiceProvider, typeof(RiskEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new RiskDocView(docData, this.ServiceProvider);
		}
	}
}
