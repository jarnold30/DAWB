...
cond('Common', 'access to own account') .
assetHasCondition( 'Bank Account', 'Bank Accounts', cond('Common', 'access to own account') ).
cond('Common', 'RO access to all accounts') .
assetHasCondition( 'Bank Account', 'Bank Accounts', cond('Common', 'RO access to all accounts') ).
cond('Common', 'RW access to all acounts') .
assetHasCondition( 'Bank Account', 'Bank Accounts', cond('Common', 'RW access to all acounts') ).
...
cond('Auditor UI', 'Auditor password') .
