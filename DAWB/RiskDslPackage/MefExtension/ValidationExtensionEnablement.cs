...
using DesignerExtensionEnablement = global::JA.Risk.ExtensionEnablement;
...
namespace JA.Risk
{
	...
	/// </summary>
	internal abstract partial class RiskDocDataBase
	{
		/// <summary>
		...
		partial void SetValidationExtensionRegistrar(DslValidation::ValidationController validationController)
		{
			if (validationController != null)
			{
				...
				if (compositionService != null)
				{
					...
					validationController.ValidationExtensionRegistrar = new DesignerExtensionEnablement::RiskValidationExtensionRegistrar();
