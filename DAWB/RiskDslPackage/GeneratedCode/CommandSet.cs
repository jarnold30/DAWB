...
namespace JA.Risk
{
	...
	{
		/// <summary>
		/// Constructs a new RiskCommandSet.
		/// </summary>
		public RiskCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class RiskCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new RiskCommandSetBase.
		/// </summary>
		protected RiskCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewRiskExplorerCommand,
				typeof(RiskEditorFactory).GUID);
		...
		{
			RiskExplorerToolWindow explorer = this.RiskExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentRiskDocData != null && this.CurrentRiskDocData.Store != null)
			{
				this.CurrentRiskDocData.ValidationController.Validate(this.CurrentRiskDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentRiskDocData != null && this.CurrentRiskDocData.Store != null)
			{
				...
				this.CurrentRiskDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected RiskDocData CurrentRiskDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as RiskDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected RiskDocView CurrentRiskDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as RiskDocView;
			}
		}
		...
		/// </summary>
		protected RiskExplorerToolWindow RiskExplorerToolWindow
		{
			get
			{
				RiskExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(RiskExplorerToolWindow), true) as RiskExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				RiskExplorerToolWindow explorerWindow = this.RiskExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class RiskClipboardCommandSet : RiskClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new RiskClipboardCommandSet.
		/// </summary>
		public RiskClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class RiskClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new RiskClipboardCommandSetBase.
		/// </summary>
		protected RiskClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
