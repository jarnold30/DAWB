...
namespace JA.Risk
{
	...
	/// </summary>
	internal partial class RiskDocView : RiskDocViewBase
	{
		/// <summary>
		/// Constructs a new RiskDocView.
		/// </summary>
		public RiskDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class RiskDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new RiskDocView.
		/// </summary>
		protected RiskDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			RiskDocDataBase docData = this.DocData as RiskDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for RiskDocViewBase should be an RiskDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::JA.Risk.RiskDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::JA.Risk.RiskDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::JA.Risk.RiskToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::JA.Risk.RiskToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.RiskDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::JA.Risk.RiskHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::JA.Risk.RiskHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::JA.Risk.RiskHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
