...
%% Here is a list of elements in the model:
    run() :-
        ...
        Task_AuditorUI_Login:preConditions:insert(cond::new(common::aDiagramO('Auditor UI'), 'Auditor Password')),
        Task_AuditorUI_BufferOverflowAttack:preConditions:insert(cond::new(common::commonO, 'PT Skill')),
        State_AuditorUI_LoggedIN = state::new('Auditor UI', 'Logged In'),
        Cond_AuditorAccess = cond::new(common::aDiagramO('Auditor UI'), 'Auditor Access'),
