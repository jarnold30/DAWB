...
namespace JA.Attack
{
	...
	{
		/// <summary>
		/// Constructs a new AttackCommandSet.
		/// </summary>
		public AttackCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class AttackCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new AttackCommandSetBase.
		/// </summary>
		protected AttackCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewAttackExplorerCommand,
				typeof(AttackEditorFactory).GUID);
		...
		{
			AttackExplorerToolWindow explorer = this.AttackExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentAttackDocData != null && this.CurrentAttackDocData.Store != null)
			{
				this.CurrentAttackDocData.ValidationController.Validate(this.CurrentAttackDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentAttackDocData != null && this.CurrentAttackDocData.Store != null)
			{
				...
				this.CurrentAttackDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected AttackDocData CurrentAttackDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as AttackDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected AttackDocView CurrentAttackDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as AttackDocView;
			}
		}
		...
		/// </summary>
		protected AttackExplorerToolWindow AttackExplorerToolWindow
		{
			get
			{
				AttackExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(AttackExplorerToolWindow), true) as AttackExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				AttackExplorerToolWindow explorerWindow = this.AttackExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class AttackClipboardCommandSet : AttackClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new AttackClipboardCommandSet.
		/// </summary>
		public AttackClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class AttackClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new AttackClipboardCommandSetBase.
		/// </summary>
		protected AttackClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
